...
export function DemoSection() {
  ...
  return (
    <>
      <SEO 
        title="Demo de IA - ZettAI"
        description="Prueba nuestras demos interactivas de inteligencia artificial. Experimenta en tiempo real el poder de nuestras soluciones de IA para empresas."
        type="website"
        keywords={['demo IA', 'prueba inteligencia artificial', 'demostración IA', 'IA interactiva']}
      />
      <section 
        ref={containerRef}
        id="demo" 
