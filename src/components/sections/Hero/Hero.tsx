...
export function Hero() {
  ...
  const { isLoaded: isRobotLoaded } = useImageLoader(geometricBg)
  const { isLoaded: isCircuitLoaded } = useImageLoader(circuitLines)
  ...
  return (
    <>
      <SEO 
        title="ZettAI - Soluciones Avanzadas de Inteligencia Artificial"
        description="Transformamos empresas con soluciones de IA personalizadas. Descubre cómo la inteligencia artificial puede impulsar tu negocio al siguiente nivel."
        type="website"
        keywords={['inteligencia artificial', 'IA empresarial', 'soluciones IA', 'transformación digital', 'machine learning']}
      />
      <motion.section 
        ref={containerRef}
