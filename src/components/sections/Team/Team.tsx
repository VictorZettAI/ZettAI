...
export function Team() {
  return (
    <>
      <SEO 
        title="Nuestro Equipo - ZettAI"
        description="Conoce al equipo de expertos detrás de ZettAI. Profesionales especializados en inteligencia artificial, machine learning y desarrollo de soluciones tecnológicas."
        type="website"
        keywords={['equipo IA', 'expertos inteligencia artificial', 'profesionales IA', 'consultores tecnología']}
      />
